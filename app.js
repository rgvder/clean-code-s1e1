...
var createNewTaskElement=function(taskString){
    ...
    label.className='task todo-app__label';
    ...
    editInput.type="text";
    editInput.className="task todo-app__input-text";
...
var addTask=function(){
    ...
    //Create a new list item with the text from .add-item__input-text:
...
//Mark task as incomplete.
    ...
    //Append the task list item to .todo.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
